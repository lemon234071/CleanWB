...
from clean.rules_temp import main_filter, data_merge, de_ad, bert_clean, de_generic
...
def main():
    ...
    simple_loader = dataloader(args.raw_dir, 50000)
    ...
    p = Pool(args.n_p)
    for fid, data in enumerate(simple_loader):
